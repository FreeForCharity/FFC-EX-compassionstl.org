...
export const metadata: Metadata = {
  title: 'Terms of Service | CompassionSTL',
  description: 'Terms of Service for CompassionSTL website',
}
      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[1em] font-[500]">
            CompassionSTL Terms of Service
          </h1>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to CompassionSTL! These Terms of Service (“Terms”) govern your access to and use
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of CompassionSTL’s mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All donations made to CompassionSTL are voluntary and non-refundable. By making a
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All payments made to CompassionSTL are voluntary and non-refundable. No refunds will be
            given due to the nonprofit nature of CompassionSTL.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of CompassionSTL or its licensors. You agree not to use, reproduce,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            controlled by CompassionSTL. We are not responsible for the content, privacy policies,
            or practices of any third-party websites or services. You acknowledge and agree that
            CompassionSTL shall not be liable for any damages or loss caused by or in connection
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. CompassionSTL makes no
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, CompassionSTL shall not be liable for any
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless CompassionSTL, its officers,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Thank you for supporting CompassionSTL and for complying with these Terms of Service.
          </p>
        </div>
      </div>
    </div>
